...
class StormSpravka(DocumentFormal):

  def __init__(self):
    super().__init__()
    self.template_path     = "/share/meteo/odtsamples/stormvoiska.odt"
  ...
  def fillDocument(self):
    ...
    monthword   = self.body.get_variable_set("monthword")
