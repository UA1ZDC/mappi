...
# 
# Заявка на получение ГМИ от Росгидромета в мирное время
# 
class GMIRequestPeace(DocumentFormal):

  def __init__(self):
    super().__init__()
    self.template_path     = "/share/meteo/odtsamples/zaprosgmimir.odt"
