#ifndef METEO_COMMONS_SERVICES_FIELDATA_TEST_GETFIELDSDATA_H
#define METEO_COMMONS_SERVICES_FIELDATA_TEST_GETFIELDSDATA_H
...
TEST(GetFieldDataTest, EmptyDateStart) {
  ...
  FieldManyReplyPtr reply = FieldManyReplyPtr(ctrl->
...
#endif // METEO_COMMONS_SERVICES_FIELDATA_TEST_GETFIELDSDATA_H
