...
public:
  ...
  static double dmyToDoubleDay(
      int day, int month, long year, long second, int calendar = T_GREGORIAN )
  {
    return second/Astro::SECONDS_PER_DAY - .5 +
        dmyToDay( day, month, year, calendar );
  }
