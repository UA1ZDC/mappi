...
const double Astro::ROUND = .5;

const double Astro::HOURS_PER_DAY = 24.;
const int    Astro::IHOURS_PER_DAY = 24;
const double Astro::SECONDS_PER_MINUTE = 60.;
const int    Astro::ISECONDS_PER_MINUTE = 60;
const double Astro::MINUTES_PER_HOUR = 60.;
const int    Astro::IMINUTES_PER_HOUR = 60;
const double Astro::SECONDS_PER_HOUR = Astro::SECONDS_PER_MINUTE * Astro::MINUTES_PER_HOUR;
const int    Astro::ISECONDS_PER_HOUR = Astro::ISECONDS_PER_MINUTE * Astro::IMINUTES_PER_HOUR;
const double Astro::MINUTES_PER_DAY = Astro::HOURS_PER_DAY * Astro::MINUTES_PER_HOUR;
const double Astro::SECONDS_PER_DAY = Astro::MINUTES_PER_DAY * Astro::SECONDS_PER_MINUTE;
