#ifndef METEO_COMMONS_UI_GRAPH_AUTOTEST_AUTOTEST_H
#define METEO_COMMONS_UI_GRAPH_AUTOTEST_AUTOTEST_H
...
#endif // METEO_COMMONS_UI_GRAPH_AUTOTEST_AUTOTEST_H
