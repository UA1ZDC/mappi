#ifndef METEO_COMMONS_UI_GRAPH_VALUEACTION_COMBOLABELITEM_H
#define METEO_COMMONS_UI_GRAPH_VALUEACTION_COMBOLABELITEM_H
...
Q_DECLARE_METATYPE( ::meteo::graph::ComboLabelItem* )
