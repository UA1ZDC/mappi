#ifndef METEO_COMMONS_UI_CUSTOM_DOUBLESLIDER_H
#define METEO_COMMONS_UI_CUSTOM_DOUBLESLIDER_H
/*=========================================================================
...
/// \ingroup Widgets
///
/// A DoubleSlider is a slider that lets you input 2 values instead of one
...
public:
  ...
  /// Constructor, builds a DoubleSlider that ranges from 0 to 100 and has
  /// a lower and upper values of 0 and 100 respectively, other properties
  /// are set the QSlider default properties.
  explicit DoubleSlider( Qt::Orientation o, QWidget* par= 0 );
  explicit DoubleSlider( QWidget* par = 0 );
  virtual ~DoubleSlider();

  void setSingle(bool single) {single_ = single;}
...
protected:
  DoubleSlider( DoubleSliderPrivate* impl, Qt::Orientation o, QWidget* par= 0 );
  DoubleSlider( DoubleSliderPrivate* impl, QWidget* par = 0 );
...
protected:
  QScopedPointer<DoubleSliderPrivate> d_ptr;
...
#endif // METEO_COMMONS_UI_CUSTOM_DOUBLESLIDER_H
