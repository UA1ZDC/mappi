...
StretchItemDelegate::StretchItemDelegate( QWidget* p )
  : QAbstractItemDelegate(p)
{

}

void StretchItemDelegate::paint(QPainter* p,
...
QSize StretchItemDelegate::sizeHint(const QStyleOptionViewItem& o, const QModelIndex& i ) const
{
  QString text = i.data(Qt::DisplayRole).toString();
  QFont font(o.font);
  font.setPointSize(QFontInfo(font).pointSize() * 3/2);
...
StretchComboBox::StretchComboBox( QWidget* p )
  : QComboBox(p)
{
}

StretchComboBox::~StretchComboBox()
{
}

QSize StretchComboBox::sizeHint() const
{
...
bool StretchComboBox::event( QEvent* e )
{
