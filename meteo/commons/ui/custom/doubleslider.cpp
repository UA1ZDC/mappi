...
public:
  ...
  DoubleSliderPrivate::Handles m_SelectedHandles;
...
private:
  Q_DISABLE_COPY(DoubleSliderPrivate);
};
...
// --------------------------------------------------------------------------
DoubleSliderPrivate::Handle DoubleSliderPrivate::handleAtPos(const QPoint& pos, QRect& handleRect)const
{
  Q_Q(const DoubleSlider);
...
//
int DoubleSliderPrivate::pixelPosToRangeValue( int pos ) const
{
  Q_Q(const DoubleSlider);
  QStyleOptionSlider option;
  q->initStyleOption( &option );
...
//---------------------------------------------------------------------------
int DoubleSliderPrivate::pixelPosFromRangeValue( int val ) const
{
  Q_Q(const DoubleSlider);
  QStyleOptionSlider option;
  q->initStyleOption( &option );
...
void DoubleSliderPrivate::drawMinimumSlider( QStylePainter* painter ) const
{
  Q_Q(const DoubleSlider);
  QStyleOptionSlider option;
...
void DoubleSliderPrivate::drawMaximumSlider( QStylePainter* painter ) const
{
  Q_Q(const DoubleSlider);
  QStyleOptionSlider option;
...
// --------------------------------------------------------------------------
DoubleSlider::DoubleSlider(QWidget* _parent)
  : QSlider(_parent)
...
// --------------------------------------------------------------------------
DoubleSlider::DoubleSlider( Qt::Orientation o,
...
// --------------------------------------------------------------------------
DoubleSlider::DoubleSlider(DoubleSliderPrivate* impl, QWidget* _parent)
  : QSlider(_parent)
  , d_ptr(impl)
{
  Q_D(DoubleSlider);
...
// --------------------------------------------------------------------------
DoubleSlider::DoubleSlider( DoubleSliderPrivate* impl, Qt::Orientation o,
                                QWidget* parentObject )
  :QSlider(o, parentObject)
  , d_ptr(impl)
{
...
// --------------------------------------------------------------------------
int DoubleSlider::minimumValue() const
{
...
// --------------------------------------------------------------------------
void DoubleSlider::setMinimumValue( int min )
{
  Q_D(DoubleSlider);
...
// --------------------------------------------------------------------------
int DoubleSlider::maximumValue() const
{
  Q_D(const DoubleSlider);
...
// --------------------------------------------------------------------------
void DoubleSlider::setMaximumValue( int max )
{
  Q_D(DoubleSlider);
...
// --------------------------------------------------------------------------
void DoubleSlider::setValues(int l, int u)
{
  Q_D(DoubleSlider);
  const int minValue =
...
// --------------------------------------------------------------------------
int DoubleSlider::minimumPosition() const
{
  Q_D(const DoubleSlider);
...
// --------------------------------------------------------------------------
int DoubleSlider::maximumPosition() const
{
  Q_D(const DoubleSlider);
...
// --------------------------------------------------------------------------
void DoubleSlider::setMinimumPosition(int l)
{
  Q_D(const DoubleSlider);
...
// --------------------------------------------------------------------------
void DoubleSlider::setMaximumPosition(int u)
{
  Q_D(const DoubleSlider);
...
// --------------------------------------------------------------------------
void DoubleSlider::setPositions(int min, int max)
{
  Q_D(DoubleSlider);
...
// --------------------------------------------------------------------------
void DoubleSlider::setSymmetricMoves(bool symmetry)
{
  Q_D(DoubleSlider);
...
// --------------------------------------------------------------------------
bool DoubleSlider::symmetricMoves()const
{
  Q_D(const DoubleSlider);
...
// --------------------------------------------------------------------------
void DoubleSlider::onRangeChanged(int _minimum, int _maximum)
{
  Q_UNUSED(_minimum);
  Q_UNUSED(_maximum);
  Q_D(DoubleSlider);
...
void DoubleSlider::paintEvent( QPaintEvent* )
{
  ...
  sr.setX(sr.x() - 5);
  sr.setWidth(sr.width() + 5);
  sr.setHeight(sr.height());
  painter.setPen(Qt::NoPen);
  painter.setBrush(QBrush(palette().color(QPalette::Active, QPalette::Window)));
  painter.drawRect(sr);

  painter.setPen(Qt::SolidLine);

  groove.setX(groove.x() + 7);
  groove.setWidth(groove.width() - 7);
  groove.setHeight(groove.height() - 2);
  painter.setBrush(QBrush(palette().color(QPalette::Normal, QPalette::Base)));
...
void DoubleSlider::mousePressEvent(QMouseEvent* mouseEvent)
{
  Q_D(DoubleSlider);
  ...
  QRect handleRect;
  DoubleSliderPrivate::Handle handle_ = d->handleAtPos(mouseEvent->pos(), handleRect);

  if (handle_ != DoubleSliderPrivate::NoHandle)
    {
    d->m_SubclassPosition = (handle_ == DoubleSliderPrivate::MinimumHandle)?
  ...
  if (control == QStyle::SC_SliderGroove &&
    ...
    if (!this->isMinimumSliderDown() || !this->isMaximumSliderDown())
      {
      d->m_SelectedHandles =
        QFlags<DoubleSliderPrivate::Handle>(DoubleSliderPrivate::MinimumHandle) |
        QFlags<DoubleSliderPrivate::Handle>(DoubleSliderPrivate::MaximumHandle);
...
// --------------------------------------------------------------------------
// Standard Qt UI events
void DoubleSlider::mouseMoveEvent(QMouseEvent* mouseEvent)
{
  Q_D(DoubleSlider);
...
// --------------------------------------------------------------------------
bool DoubleSlider::isMinimumSliderDown()const
{
  Q_D(const DoubleSlider);
  return d->m_SelectedHandles & DoubleSliderPrivate::MinimumHandle;
}

// --------------------------------------------------------------------------
bool DoubleSlider::isMaximumSliderDown()const
{
  Q_D(const DoubleSlider);
  return d->m_SelectedHandles & DoubleSliderPrivate::MaximumHandle;
}

// --------------------------------------------------------------------------
void DoubleSlider::initMinimumSliderStyleOption(QStyleOptionSlider* option) const
{
  this->initStyleOption(option);
}

// --------------------------------------------------------------------------
void DoubleSlider::initMaximumSliderStyleOption(QStyleOptionSlider* option) const
{
  this->initStyleOption(option);
}
...
// --------------------------------------------------------------------------
void DoubleSlider::setHandleToolTip(const QString& _toolTip)
{
  Q_D(DoubleSlider);
...
// --------------------------------------------------------------------------
bool DoubleSlider::event(QEvent* _event)
{
  Q_D(DoubleSlider);
  switch(_event->type())
    {
