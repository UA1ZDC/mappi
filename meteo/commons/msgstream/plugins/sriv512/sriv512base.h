#ifndef METEO_COMMONS_MSGSTREAM_PLUGINS_SRIV512_BASE_TRANSMETSTREAM_H
#define METEO_COMMONS_MSGSTREAM_PLUGINS_SRIV512_BASE_TRANSMETSTREAM_H
...
class Sriv512Base: public QObject
{
  Q_OBJECT
public:
...
public:
  explicit Sriv512Base(const msgstream::Options &opt,
...
private:
  ...
  bool getStartPacket();
  bool getEndPacket();
  bool processAck(const sriv512::ServicePacket& );
  void writeBox(const sriv512::SendBox &);
  bool writeEndPacket(const sriv512::ServicePacket &);
...
private:
  ...
  // служебные
  sriv512::ServicePacket start_;
  sriv512::InfoPacket info_;
  bool isWriten = true;

protected:
  sriv512::RecvState state_;
  int port_;
  QString host_;
  QTcpSocket* socket_=nullptr;
  QMap<quint16,sriv512::SendBox> sentList_;
