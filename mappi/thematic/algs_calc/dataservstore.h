...
namespace mappi {
  namespace to {
    ...
    public:
      ...
      virtual bool save(const struct meteo::global::PoHeader& header, conf::ThemType type,
                        const std::string &themname, const QString& fileName, const std::string &format);
