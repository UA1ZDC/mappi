...
static ASMJIT_INLINE bool X86RAPass_mustConvertSArg(X86RAPass* self, uint32_t dstTypeId, uint32_t srcTypeId) noexcept{
  (void)self;
  bool dstFloatSize = dstTypeId == TypeId::kF32   ? true :
                      dstTypeId == TypeId::kF64   ? true : 0;

  bool srcFloatSize = srcTypeId == TypeId::kF32   ? true :
                      srcTypeId == TypeId::kF32x1 ? true :
                      srcTypeId == TypeId::kF64   ? true :
                      srcTypeId == TypeId::kF64x1 ? true : 0;
