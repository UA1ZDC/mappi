...
//NOTE копия из #include <meteo/commons/ui/mainwindow/appmain/appmain.h>
//добавлены пути плагинов для mappi, чтение настроек
...
*/
    ...
    window->addPluginGroup("mappi.app.widgets");
...
{
  appMain( argc, argv,"Сбор и обработка спутниковой информации",
           ":/meteo/splash/splash.png", ":/meteo/icons/misc/windowico.png" );
}
...
//         window = new meteo::app::MainWindow;
//     }
//     window->setWindowTitle(QObject::tr("Сюжет"));
//     window->show();
