...
# Generated: Tue Nov 21 11:51:16 2017
##################################################
...
class meteor2_hrpt(gr.top_block):
    ...
    def __init__(self):
        ...
        self.config_filename = config_filename = os.environ['HOME']+'/.gnuradio/config_ololo.conf'
        ...
        self.analog_agc_xx_0 = analog.agc_cc(1e-4, 1.0, 1.0/32.0)
        self.analog_agc_xx_0.set_max_gain(65536.0)
...
def main(top_block_cls=meteor2_hrpt, options=None):
